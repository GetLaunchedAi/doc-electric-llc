...
// Configuration
const CONFIG = {
  baseUrl: 'https://midocelectric.com/',
  ...
  rules: {
    ...
    '/servicepages/electric-car-chargers/': { priority: '0.70', changefreq: 'monthly' },
    '/servicepages/generators/': { priority: '0.70', changefreq: 'monthly' },
    '/servicepages/new-construction-wiring/': { priority: '0.70', changefreq: 'monthly' },
    '/servicepages/residential-service-and-repair/': { priority: '0.70', changefreq: 'monthly' },
    '/servicepages/solar-and-panel-upgrades/': { priority: '0.70', changefreq: 'monthly' },
    '/servicepages/specialty-lighting/': { priority: '0.70', changefreq: 'monthly' },
